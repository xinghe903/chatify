...
const file_service_v1_service_proto_rawDesc = "" +
	...
	"\aService\x12:\n" +
	"\n" +
	"ChatStream\x12\x13.service.v1.ChatReq\x1a\x13.service.v1.ChatRsp(\x010\x01\x120\n" +
	"\x04Chat\x12\x13.service.v1.ChatReq\x1a\x13.service.v1.ChatRspB\x13Z\x11api/service/v1;v1b\x06proto3"
...
var file_service_v1_service_proto_depIdxs = []int32{
	0, // 0: service.v1.Service.ChatStream:input_type -> service.v1.ChatReq
	0, // 1: service.v1.Service.Chat:input_type -> service.v1.ChatReq
	1, // 2: service.v1.Service.ChatStream:output_type -> service.v1.ChatRsp
	1, // 3: service.v1.Service.Chat:output_type -> service.v1.ChatRsp
