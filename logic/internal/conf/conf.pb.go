...
type Bootstrap struct {
	...
	PushClient    *PushClient            `protobuf:"bytes,3,opt,name=push_client,json=pushClient,proto3" json:"push_client,omitempty"`
...
func (x *Bootstrap) GetPushClient() *PushClient {
	if x != nil {
		return x.PushClient
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\xce\x01\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x127\n" +
	"\vpush_client\x18\x03 \x01(\v2\x16.kratos.api.PushClientR\n" +
	"pushClient\x126\n" +
	"\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xa5\x04\n" +
	"\x04Data\x125\n" +
	...
	"\bpassword\x18\x04 \x01(\tR\bpassword\"\xbc\x01\n" +
	"\n" +
	"Monitoring\x12!\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*PushClient)(nil),          // 1: kratos.api.PushClient
	...
	(*Data_Etcd)(nil),           // 12: kratos.api.Data.Etcd
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	1,  // 2: kratos.api.Bootstrap.push_client:type_name -> kratos.api.PushClient
	4,  // 3: kratos.api.Bootstrap.monitoring:type_name -> kratos.api.Monitoring
	15, // 4: kratos.api.PushClient.timeout:type_name -> google.protobuf.Duration
	...
	12, // 9: kratos.api.Data.etcd:type_name -> kratos.api.Data.Etcd
	5,  // 10: kratos.api.Monitoring.tracing:type_name -> kratos.api.Tracing
	6,  // 11: kratos.api.Monitoring.logging:type_name -> kratos.api.Logging
	7,  // 12: kratos.api.Monitoring.metrics:type_name -> kratos.api.Metrics
	13, // 13: kratos.api.Tracing.jaeger:type_name -> kratos.api.Tracing.Jaeger
	14, // 14: kratos.api.Metrics.prometheus:type_name -> kratos.api.Metrics.Prometheus
	...
	15, // 19: kratos.api.Data.Etcd.dial_timeout:type_name -> google.protobuf.Duration
